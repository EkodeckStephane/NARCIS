...
fig.tight_layout()
fig.savefig(FIGURES / "bossbase_convergence.pdf", bbox_inches="tight")
fig.savefig(FIGURES / "bossbase_convergence.png", dpi=300, bbox_inches="tight")
plt.close(fig)
...
fig.tight_layout()
fig.savefig(FIGURES / "bossbase_attack_accuracy.pdf", bbox_inches="tight")
fig.savefig(FIGURES / "bossbase_attack_accuracy.png", dpi=300, bbox_inches="tight")
plt.close(fig)
