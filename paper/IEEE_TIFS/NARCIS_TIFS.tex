...
210/210. Selection bias was measured with three detector classes. On BOSSBase,
all confidence intervals include chance performance. On Caltech-101,
classical detectors identified a weak selection shift (global logistic
AUC 0.531, 95\%~CI~[0.504, 0.557]; residual ExtraTrees 0.533,
[0.504, 0.562]); 20 repeated CNN fits on the most sensitive partition
confirmed a partition-specific signal (mean~AUC~0.533,
95\%~CI~[0.517, 0.548]).
\end{abstract}
