...
\end{equation}
This is a declared planning model, not a cryptographic independence claim. For the balanced 7,000-image external index, each label has $a_k=175$ disjoint five-cover groups.
\begin{table}[t]
