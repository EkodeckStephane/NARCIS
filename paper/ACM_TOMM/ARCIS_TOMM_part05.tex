...
The CNN mean AUC of 0.527 describes the selected-vs.-remainder discrimination problem defined by the frozen shared index. Session-volume observability is analyzed separately through the measured transmission counts, while temporal correlation, semantic side information, and adaptive deployment-specific wardens provide complementary evaluation layers for future deployments.
